"""WS-EDIT-MECH (v0.6.0) — de-novo oncogenic-fusion detection by MECHANISM, generalizing beyond the curated
gene-PAIR lookup (vendored_data/oncogenic_fusions.yaml). 'AI can design what isn't catalogued', so the edit axis
