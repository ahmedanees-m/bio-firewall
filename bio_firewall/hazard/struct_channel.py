"""A structural remote-homology channel + a 3-signal ensemble for the cargo axis.
...
also backstops the cargo composition-decorrelation analysis (the cleanest refutation of the composition confound).
...
def confidence_gated_score(esm, struct, plddt, plddt_min: float = 70.0):
    """A confidence-gated fusion. The mean ensemble failed at 1%-FPR because a weak, low-confidence fold channel
