...
(`bio_firewall/vendored_data/cargo_centroids.npz`, derived from PUBLIC toxin/benign reference proteins - only the centroid
...
_VD = Path(__file__).resolve().parents[1] / "vendored_data"   # bio_firewall/hazard/ -> bio_firewall/
