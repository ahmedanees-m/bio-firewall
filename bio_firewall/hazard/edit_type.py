...
def screen_edit(plan: dict) -> Finding:
    ...
    if fg and len(fg) == 2:
        ...
        # de-novo detection: flag an off-list fusion by MECHANISM (kinase activation /
        ...
        if is_mech:
            return finding("soft_penalty", "edit.denovo_oncogenic_fusion", "edit_type",
                           ...
                           provenance={"source": "de-novo fusion-mechanism screen (fusion-kinase / oncogene roles, CC0)"})
