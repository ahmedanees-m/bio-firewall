"""IBBIS-DSSC alignment + the OSTP interagency-window note.

The living hazard-KB (bio_firewall/vendored_data/hazard_kb/<v>.yaml) is described against the IBBIS DNA Screening Standards
