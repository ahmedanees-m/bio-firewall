"""WS-CONFORMAL-NP (v0.8.0) - optimal-power Neyman-Pearson conformal selection for the escalate / route-to-review
decision.

The v0.4 layer thresholds a SCALAR risk score and certifies P(escalate | legitimate research) <= alpha with a
...
The head-to-head (v0.4 scalar threshold vs NP likelihood-ratio conformal selection at matched alpha) is OUR
...
def scalar_threshold_select(legit_calib: np.ndarray, test_scores: np.ndarray, alpha: float) -> np.ndarray:
    """The v0.4 baseline: pick the threshold at the (1-alpha) empirical quantile of the legitimate calibration scores
