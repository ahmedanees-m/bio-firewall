"""Benchmark 8: de-novo fusion-mechanism generalization. Does the de-novo mechanism screen flag known oncogenic
fusions that are ABSENT from the curated gene-pair list, with a controlled false-positive on benign constructs?

De-circularization: the curated list is `bio_firewall/vendored_data/oncogenic_fusions.yaml` (14 canonical pairs). The held-out
