"""Outcome-validate the locus axis on REAL integration-site data, the open-data floor.
...
catalogue PEN-STACK's genotoxicity oracle uses (local-only on the VM; never committed). Each integration site
