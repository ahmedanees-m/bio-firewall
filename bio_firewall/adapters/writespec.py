"""WS-WRITESPEC (v0.9.1) - screen the typed PEN-STACK 7.0 Stage A WriteRequest (SBOL3 profile) directly.

BioFirewall normally screens a `design: dict`. v7.0's `pen_stack.spec.WriteRequest` is a typed, ontology-backed intent
...
Honest-failure contract: where a hazard-relevant field is null/unresolved, BioFirewall screens what IS present and
