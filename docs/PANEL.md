...
- **Powered N, fixed seed (1234).** Cargo: n=200 held-out ≤40%-id sequences. Determinism: 10 plans × runs.
...
Powering up **withdrew** two weak claims and **confirmed** two strong ones (reported straight — this honesty is the
point):
...
- **B — determinism: WITHDRAWN.** At 10 plans × 30 runs all open models are stable at temp 0; the small-N "unstable"
