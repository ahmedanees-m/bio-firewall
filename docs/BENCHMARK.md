...
> benchmark - de-circularized, with earned baselines, powered, and - per
...
/ OmniTox [Mathew 2025, PMC12699701]; the contribution is the governed five-axis integration + this benchmark.) **-> v0.4.0 follows this confound to ground
...
Monotone **high > moderate > low** yes (the v0.3 scheme was *uninformative* on this split - allow-tier 0.782 ~
...
## Benchmark 10 - structural remote-homology channel (WS-STRUCT) - negative result at 1% FPR
